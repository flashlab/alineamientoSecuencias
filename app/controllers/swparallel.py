...
mismatch = -1
gap      = -1
seq1 = 'AGCACACAAGCACACAAGCACACAAGCACACAAGCACACAAGCACACAAGCACACAAGCACACAAGCACACA'
seq2 = 'ACACACTAACACACTAACACACTAACACACTAACACACTAACACACTAACACACTAACACACTAACACACTA'
# seq1     = None
# seq2     = None
...
def create_score_matrix(rows, cols):
    ...
    for i in range(1, rows):
        for j in range(1, cols):
            try:
                score = job_server.submit(calc_score, (score_matrix, i, j, ))
            except Exception as e:
                print "Error"
                print e
                return
                # calc_score(score_matrix, i, j)
            if score > max_score:
                max_score = score
                max_pos   = (i, j)
