...
def model_fields(model, db_session=None, only=None, exclude=None,
                 ...
                 exclude_fk=False):
    """
    Generate a dictionary of fields for a given SQLAlchemy models.
...
def model_form(model, db_session=None, base_class=Form, only=None,
    ...
    """
    Create a wtforms Form for a given SQLAlchemy models class::
    ...
    :param model:
        A SQLAlchemy mapped models class.
    :param db_session:
    ...
    if not hasattr(model, '_sa_class_manager'):
        raise TypeError('models must be a sqlalchemy mapped models')
