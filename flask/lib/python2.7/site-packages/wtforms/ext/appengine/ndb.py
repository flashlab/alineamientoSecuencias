...
class ModelConverterBase(object):
    def __init__(self, converters=None):
        ...
        :param converters:
            ...
            callable must accept the arguments (models, prop, kwargs).
        """
        self.converters = {}
    ...
    def convert(self, model, prop, field_args):
        """
        Returns a form field for a single models property.

        :param model:
            The ``db.Model`` class that contains the property.
        :param prop:
            The models property: a ``db.Property`` instance.
        :param field_args:
    ...
    def convert_KeyProperty(self, model, prop, kwargs):
        ...
        if 'reference_class' not in kwargs:
            ...
            if isinstance(reference_class, string_types):
                # reference class is a string, try to retrieve the models object.
...
def model_fields(model, only=None, exclude=None, field_args=None,
    ...
    :param converter:
        A converter to generate the fields based on the models properties. If
    ...
    # full list of models properties.
...
def model_form(model, base_class=Form, only=None, exclude=None, field_args=None,
    ...
    for extended form classes, which can then mix non-models related fields,
    subforms with other models forms, among other possibilities.
    ...
    :param converter:
        ...
        not set, ``ModelConverter`` is used.
    """
    # Extract the fields from the models.
